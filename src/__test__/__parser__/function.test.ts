import { ArrowFunctionLiteral, BlockStatement, CallExpression, AssignExpression, ExpressionStatement, FunctionLiteral, Identifier, InfixExpression } from "../../interfaces/nodes";
